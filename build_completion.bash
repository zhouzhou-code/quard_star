...
_build_sh_completion() {
    ...
    # 定义第一层参数 (targets)
    opts="all check clean qemu boot opensbi uboot kernel buildroot freertos rootfs firmware driver verify-driver kernelconfig ubootconfig buildrootconfig submodules libmetal openamp openamp-adapter"
